...
describe('test HolyTime.startOf', () => {
  it('should return start of unit', () => {
    ...
    expect(date.startOf('hour').getISOString()).toBe('2023-01-01T01:00:00.000Z');
    expect(date.startOf('day').getISOString()).toBe('2023-01-01T00:00:00.000Z');
    expect(date.startOf('week').getISOString()).toBe('2023-01-01T00:00:00.000Z');
    expect(date.startOf('month').getISOString()).toBe('2023-01-01T00:00:00.000Z');
    expect(date.startOf('year').getISOString()).toBe('2023-01-01T00:00:00.000Z');
  });
});
